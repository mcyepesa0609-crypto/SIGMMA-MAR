...
import { CATALOG, computeRouteAScores, MIN_REQUIRED } from "./catalog/catalog.js";
...
/* Grupo 3 por NOMBRE de la técnica (normalizado) */
const TECH_ICON_BY_NAME = {
  ...
  [normalizeToken("Tratamiento suelo–acuífero")]: "/images/SAT.png",
  [normalizeToken("Tratamiento sueloacuifero")]: "/images/SAT.png",
  [normalizeToken("Tratamiento suelo-acuifero")]: "/images/SAT.png",
...
const MAP_LAYERS_BY_MODULE = {
  geologico: [
    { id: "mapa-geologico", label: "Geológico", preview: "/images/mapa_geologico.png" },
  ...
  hidraulico: [
    ...
    { id: "nivel-freatico", label: "Nivel freático", preview: "/images/mapa_nivel_freatico.png" },
  ],
  hidrologico: [
    { id: "recarga", label: "Recarga", preview: "/images/mapa_recarga.png" },
    { id: "precipitacion", label: "Precipitación", preview: "/images/mapa_precipitacion.png" },
  ],
  hidrogeoquimico: [],
  caracterizacion: [
    { id: "unidades-hidrogeologicas", label: "Unidades hidrogeológicas", preview: "/images/mapa_unidades_hidrogeologicas.png" },
  ],
  fuente: [],
  volumen: [],
  infraestructura: [],
...
const MODULE_FIELDS = {
  geologico: [
    {
      ...
      help:
        "Indique el nombre oficial de la unidad litoestratigráfica dominante donde se localiza el sistema acuífero evaluado (p. ej., Formación Tilata)",
    },
    {
    ...
    {
      name: "espesor_unidad_geologica_m",
      label: "Espesor (m)",
      help:
        "Indique el espesor de la unidad geológica en metros (m) dentro del área de estudio. Si se reportan techo y base, calcule el espesor como (base − techo) y regístrelo. En caso de no contar con ambos valores, registre el espesor estimado o el valor reportado por la fuente.",
    },
    {
  ...
  hidraulico: [
...

    {
      ...
      help: "Clasificación del acuífero según su comportamiento hidráulico y la presión a la que se encuentra el agua en su interior. Seleccione la categoría que mejor describa la unidad evaluada.",
    },
...

    {
      ...
      label: "Coeficiente de almacenamiento S (S o Sy)",
    ...
    { name: "fuente_parametros", label: "Fuente de los parametros", help: "Registro de la referencia (autor, año) que otorga validez técnica y trazabilidad a los datos ingresados (p. ej. Yepes, 2025)." },
  ],
  ...
  hidrologico: [
    ...
    { name: "subcuenca_o_rio", label: "Subcuenca o río", help: "Indique el nombre específico de la unidad hídrica menor o del cuerpo de agua superficial que drena directamente hacia el punto de monitoreo (p. ej., Río Aburrá o Quebrada La Presidenta)" },
    { name: "area_cuenca_km2", label: "Área cuenca (km2)", help: "Escriba el valor numérico de la superficie de drenaje total que aporta agua al punto de control, obtenida según la delimitación cartográfica o el modelo hidrológico del estudio (p. ej., 125.4)" },
    { name: "periodo_analisis", label: "Periodo análisis", help: "Especifique el rango de años consecutivos de la serie histórica utilizada para los cálculos hidrológicos, asegurando que sea el mismo para todas las variables climáticas (p. ej., 1991–2021)" },
    { name: "p_med_anual_mm", label: "Precipitación media anual (mm)", help: "Ingrese el promedio de lluvia total acumulada anualmente sobre la cuenca aportante para el periodo de análisis definido, expresado en milímetros (p. ej., 2100)" },
    { name: "q_med_anual_m3s", label: "Volumen medio anual (m3/s)", help: "Reporte el volumen de agua promedio que circula por el punto de control por unidad de tiempo, calculado rigurosamente sobre el mismo periodo de análisis (p. ej., 5.8)." },
  ],

  hidrogeoquimico: [
    { name: "unidad_acuifero_asociada", label: "Unidad acuífero asociada", help: "Registre el nombre oficial de la formación geológica o la unidad hidrogeológica específica a la que pertenece la muestra de agua recolectada, asegurando la concordancia con el modelo geológico previamente definido (p. ej., Acuífero Formación Tilatá)." },
    { name: "facies_hidroquimica_descriptiva", label: "Facie hidroquímica", help: "Indique la clasificación química del agua obtenida mediante el diagrama de Piper, mencionando los iones dominantes tanto en cationes como en aniones (p. ej., Bicarbonatada cálcica y/o magnésica)" },
    {
      name: "proceso_hidrogeoquimico_dominante",
      label: "Proceso hidrogeoquímico dominante",
      type: "textarea",
    ...
    { name: "ce_uScm", label: "CE (uS/cm)", help: "Registre la conductividad eléctrica medida en microsiemens por centímetro, parámetro que actúa como un indicador directo de la mineralización y el contenido iónico del agua (p. ej., 450)." },
    { name: "tds_mgL", label: "TDS (mg/L)", help: "Escriba la concentración de Sólidos Disueltos Totales o el residuo seco expresado en miligramos por litro, que representa la suma de todos los componentes minerales disueltos (p. ej., 320)." },
    { name: "ca_mgL", label: "Ca (mg/L)", help: "Ingrese la concentración del ion Calcio (Ca²⁺) determinada en el análisis de laboratorio, fundamental para definir la dureza y las facies del agua (p. ej., 45)." },
    { name: "mg_mgL", label: "Mg (mg/L)", help: "Reporte la concentración de Magnesio (Mg²⁺) presente en la muestra, componente clave en la caracterización hidroquímica de acuíferos sedimentarios (p. ej., 12)." },
    { name: "na_mgL", label: "Na (mg/L)", help: "Registre la concentración de Sodio (Na⁺), útil para identificar procesos de intercambio catiónico o influencias de aguas antiguas y salinas (p. ej., 25)." },
    { name: "k_mgL", label: "K (mg/L)", help: "Indique la concentración de Potasio (K⁺), ion que suele encontrarse en menores proporciones y cuya presencia puede estar ligada a la alteración de silicatos o uso de fertilizantes (p. ej., 2.1)." },
    { name: "hco3_mgL", label: "HCO3 (mg/L)", help: "Escriba el valor de Bicarbonatos o la alcalinidad total expresada como HCO₃⁻, que refleja el sistema de equilibrio del carbono en el acuífero (p. ej., 180)." },
    { name: "cl_mgL", label: "Cl (mg/L)", help: "Reporte la concentración de Cloruros (Cl⁻), parámetro esencial para detectar procesos de salinización o contaminación (p. ej., 15)." },
    { name: "so4_mgL", label: "SO4 (mg/L)", help: "Registre la concentración de Sulfatos (SO₄²⁻), la cual puede indicar disolución de yesos o presencia de minerales oxidados (p. ej., 30)." },
    { name: "no3_mgL", label: "NO3 (mg/L)", help: "Ingrese la concentración de Nitratos (NO₃⁻), parámetro crítico para evaluar la calidad del agua y posibles impactos por actividades agrícolas o vertimientos (p. ej., 5)." },
    { name: "fuente_datos_analiticos", label: "Fuente de datos analíticos", help: "Proporcione una referencia corta y precisa que permita rastrear el origen de la información química, incluyendo el autor y el año del estudio o informe técnico (p. ej., Yepes, 2025)." },
  ],

  caracterizacion: [
    { name: "uhg_codigo", label: "Unidad hidrogeológica (UHG)", help: "Asigne un código único y secuencial que identifique la Unidad Hidrogeológica dentro del estudio, permitiendo agrupar capas geológicas con comportamientos hidráulicos similares bajo una misma denominación (p. ej., UHG-1, UHG-2)"},
    { name: "unidad_geologica_asociada", label: "Unidad geológica asociada", help: "Indique la formación, miembro o tipo de litología específica que compone físicamente a la UHG, manteniendo total coherencia con el modelo geológico regional y local definido previamente (p. ej., Formación Tilatá o Depósitos Aluviales)"},
    {
      ...
      label: "Comportamiento hidrogeológico de la UHG",
      type: "select",
      options: ["Acuífero", "Acuitardo", "Acuicludo", "Acuífugo"],
      help:
        "Defina la función de la unidad dentro del sistema según su capacidad de transmitir y almacenar agua, clasificándola como acuífero, acuitardo, acuicludo o acuífugo",
    },
    {
      name: "porosidad",
      label: "Porosidad",
  ...
  fuente: [
    ...
    {
      name: "tipo_fuente_superficial",
      label: "Tipo de fuente de agua superficial",
      type: "select",
      options: ["Río permanente", "Río estacional", "Río efímero", "Lago/Embalse"],
      help: "Solo aplica si la fuente es superficial; ayuda a diferenciar G1 y G3.",
    },
    {
      name: "conexion_hidraulica",
      label: "Conexión hidráulica con el río",
      type: "select",
      options: ["Río ganador", "Río perdedor", "Sin conexión"],
      help: "Indique si hay conexion hidraulica con el rio (ganador/perdedor) o si no existe.",
    },

    {
      name: "categoria_calidad_mar",
      label: "Categoría calidad del agua para MAR ",
      type: "select",
      options: ["Apta", "Apta con pretratamiento", "No apta", "No evaluada"],
      help:
        "Clasificación de la calidad del agua para la recarga."
    },
    { name: "coliformes_totales", label: "Coliformes totales", help: "Registre la concentración de estos indicadores microbiológicos en las unidades reportadas por el laboratorio (NMP/100\ mL o UFC/100\ mL), ya que son los parámetros críticos para evaluar el riesgo sanitario y la seguridad del proceso de recarga"},
    { name: "coliformes_fecales", label: "Coliformes fecales", help: "Registre la concentración de estos indicadores microbiológicos en las unidades reportadas por el laboratorio (NMP/100\ mL o UFC/100\ mL), ya que son los parámetros críticos para evaluar el riesgo sanitario y la seguridad del proceso de recarga"},
    { name: "e_coli", label: "E coli", help: "Registre la concentración de estos indicadores microbiológicos en las unidades reportadas por el laboratorio ($NMP/100\ mL$ o $UFC/100\ mL$), ya que son los parámetros críticos para evaluar el riesgo sanitario y la seguridad del proceso de recarga"},
    { name: "observacion_calidad_clave", label: "Observacion calidad clave", help: "Redacte un comentario breve y específico sobre el factor principal que limita o favorece el uso de esta fuente, como la alta turbiedad, presencia de metales o baja mineralización"},
    { name: "norma_aplicable", label: "Norma aplicable", help: "Indique la resolución o decreto vigente utilizado para la evaluación (p. ej., Decreto 1076 de 2015 en Colombia) y especifique bajo qué categoría de uso se está evaluando el agua (p. ej., uso agrícola, industrial o recarga directa)"},
    { name: "categoria_uso_norma", label: "Categoria uso norma", help: "Indique la resolución o decreto vigente utilizado para la evaluación (p. ej., Decreto 1076 de 2015 en Colombia) y especifique bajo qué categoría de uso se está evaluando el agua (p. ej., uso agrícola, industrial o recarga directa)"},
    { name: "cumple_norma_para_uso", label: "Cumple norma para uso", type: "select", options: ["Sí", "No", "Parcial", "No evaluado"], help: "Determine de forma global si la fuente satisface los requisitos legales, marcando Sí, No, o Parcial si requiere ajustes menores de calidad"},
    { name: "parametro_lim_critico", label: "Parámetro limíte crítico", help: "Identifique el componente específico (p. ej., nitratos, coliformes o sólidos suspendidos) que causa el incumplimiento de la norma o que obliga a realizar un tratamiento previo antes de iniciar la recarga"},
  ],
  ...
  volumen: [
    ...
    {
      name: "cap_infiltracion_zona_no_saturada",
      label: "¿Se estudio la capacidad de infiltracion en la zona no saturada?",
      type: "select",
      options: ["Si", "No"],
      help: "Tasa a la que el agua entra al suelo (mm/h, medida en superficie).",
    },
    {
      name: "cap_infiltracion_categoria",
      label: "Categoria de capacidad de infiltracion (mm/h)",
      type: "select",
      options: ["Muy alta (>30)", "Alta (20-30)", "Media (10-20)", "Baja (<10)", "No evaluado"],
      help: "Clasificacion segun tasa de infiltracion.",
    },
    {
    ...
    { name: "zona_o_uhg_receptora", label: "Zona o UHG receptora", help: "Registre el nombre o código de la Unidad Hidrogeológica específica que ha sido identificada para recibir el agua, asegurando que sus propiedades hidráulicas sean aptas para la infiltración o inyección (p. ej., UHG-1 o Zona Aluvial Norte)."},
    { name: "periodo_referencia", label: "Periodo de referencia", help: "Indique el intervalo de tiempo o la serie de datos climáticos e hidrológicos utilizada para calcular tanto la oferta de la fuente como la capacidad de acogida del acuífero (p. ej., Promedio anual serie 2000–2020)."},
    { name: "v_fuente_disponible_anual_m3", label: "V fuente disponible anual (m3)", help: "Reporte el volumen total anual de agua que la fuente seleccionada (superficial, residual, etc.) puede entregar efectivamente para el proyecto, considerando su régimen hidrológico y la disponibilidad concesionable (p. ej., 1.500.000)."},
    { name: "v_capacidad_almacenamiento_m3", label: "V capacidad almacenamiento (m3)", help: "Indique el volumen vacío o espacio disponible dentro del acuífero que ha sido calculado como apto para albergar agua nueva, basándose en la porosidad drenable y el espesor saturado disponible (p. ej., 850.000)."},
    { name: "v_max_recarga_segura_m3", label: "Volumen maxímo de recarga segura (m3)", help:"Registre el volumen máximo recomendado para recargar anualmente sin generar riesgos de inundación, afloramientos o cambios químicos no deseados; este valor suele ser menor o igual a la capacidad física del acuífero (p. ej., 600.000)."},
    { name: "criterio_definicion_vmax", label: "Criterio definición Vmax", type: "textarea", help: "Describa la regla técnica o el método utilizado para fijar el volumen máximo de recarga segura, como puede ser un porcentaje de la porosidad eficaz, el mantenimiento de un nivel piezométrico crítico o un límite basado en el balance hídrico (p. ej.,No exceder el 15% de la porosidad eficaz o Mantener el nivel freático a 2 metros bajo la superficie)"},
  ],

  infraestructura: [
    { name: "id_infraestructura", label: "ID infraestructura", help: "Asigne un código único y alfanumérico que permita identificar de forma inequívoca cada elemento físico en la base de datos y en la cartografía del proyecto (p. ej., INF_01, POZO_A1 o PTAR_SUR)."},
    { name: "tipo_infraestructura", label: "Tipo de infraestructura", type: "select", options: ["Pozo", "Canal", "Embalse", "Estanque", "Zanja", "PTAP", "PTAR", "Red de distribución", "Drenaje", "Obras en cauce", "No hay infraestructura existente"], help: "Seleccione la categoría técnica que mejor describa la obra hidráulica existente, diferenciando entre captaciones (pozos), sistemas de conducción (canales, redes), almacenamiento (embalses) o plantas de tratamiento (PTAP, PTAR)."},
    { name: "uso_actual", label: "Uso actual", help: "Describa la función o actividad principal que desempeña la infraestructura al momento de la evaluación, especificando si es para consumo humano, riego, vertimiento o uso industrial."},
    ...
    { name: "coordenadas_x", label: "Coordenadas x", help: "Ubicación geográfica (X o lat/long) para representarlo en el mapa." },
    { name: "coordenadas_y", label: "Coordenadas y", help: "Ubicación geográfica (Y) para representarlo en el mapa." },
    { name: "relacion_con_mar", label: "Relació con MAR", type: "select", options: ["Aprovechable", "Potencialmente afectada", "Sin relación directa", "Por evaluar"], help: "Relevancia cualitativa para MAR." },
  ],

  comunidad: [
    { name: "nombre_comunidad", label: "Nombre de la comunidad", help: "Registre el nombre oficial de la localidad, vereda, barrio o corregimiento que se encuentra dentro del área de influencia directa del proyecto (p. ej., Vereda La Clarita)." },
    { name: "tipo_asentamiento", label: "Tipo de asentamiento", type: "select", options: ["Urbano", "Rural", "Mixto", "NA", "No evaluado"], help: "Clasifique el área donde habita la comunidad según su densidad y características territoriales en Urbano, Rural o Mixto, lo cual ayuda a prever el tipo de demanda y la infraestructura necesaria." },
    { name: "poblacion_total", label: "Población total", help: "Ingrese el número total de habitantes del asentamiento basándose en los datos más recientes de fuentes oficiales, como censos nacionales o registros municipales (p. ej., 1.250 habitantes)." },
    { name: "actividad_economica_principal", label: "Actividad económica principal", help: "Identifique la fuente de ingresos o labor predominante de los habitantes, como agricultura, ganadería, comercio o industria, para entender el impacto socioeconómico del recurso hídrico (p. ej., Cultivo de hortalizas a pequeña escala)." },
    { name: "uso_final_del_agua", label: "Uso final del agua", type: "select", options: ["Doméstico", "Industrial", "Ambiental", "Agrícola", "Mixto"], help: "Defina el propósito específico que tendrá el agua tras su recuperación del acuífero." },
    { name: "condicion_beneficio", label: "Condición beneficio", type: "select", options: ["Beneficio directo", "Beneficio indirecto", "Potencial beneficiario", "No evaluado"], help: "Determine la relación esperada entre la comunidad y el proyecto." },
    { name: "percepcion_proyecto_mar", label: "Percepción proyecto MAR", type: "select", options: ["Favorable", "Neutra", "Contraria", "No evaluada"], help: "Describa el nivel de aceptación, dudas o interés manifestado por la comunidad tras las socializaciones iniciales, lo cual es clave para gestionar la viabilidad social del proyecto (p. ej., Alta aceptación con dudas sobre la calidad del agua de recarga)." },
  ],

  relieve: [
    { name: "relieve_dominante", label: "Relieve", type: "select", options: ["Llanura", "Valle", "Colina o meseta", "Montaña", "No evaluado"], help: "Seleccione la forma de terreno que predomina en el área del proyecto, lo cual determina la velocidad de la escorrentía y la capacidad de infiltración." },
...
function MainAppLayout({ onBackToLanding }) {
  ...
  const { activeCaseId, activeCase } = useCasesStore();
  const resultadosReady = Boolean(activeCase && activeCaseId && activeCaseId !== "nuevo");
  ...
  return (
    <div className="app-layout">
      ...
      <main className="content">
        ...
        {currentView === "resultados" && <Resultados ready={resultadosReady} />}
        ...
        {currentView !== "resultados" && (
          ...
          >
            <Resultados ready={resultadosReady} />
          </div>
        )}
      </main>
    </div>
...
function Introduccion({ onGoToMetodo }) {
  ...
  return (
    <section className="intro-section">
      ...
      <section className="intro-block intro-tech-explorer">
        ...
        <p className="intro-text">
          La implementación efectiva de MAR exige asegurar que la técnica seleccionada encaje perfectamente con su entorno. Por ello, este catálogo organiza 14 técnicas en una estructura jerárquica que considera el método de recarga, la infraestructura y la presión aplicada.
      ...
      <div className="intro-block intro-water-sources">
        ...
        <div className="intro-water-layout">
          <div className="intro-water-text">
            <p className="intro-text">La recarga gestionada puede utilizar distintas fuentes de agua (IGRAC, 2007; Dillon et al., 2009; Sprenger et al., 2017; Bonilla Valverde et al., 2018; Zheng et al., 2020; Sarfaraz Alam et al., 2021; Dillon et al., 2022). En esta plataforma se consideran cuatro tipos principales:</p>
      ...
      <div className="intro-block">
        ...
        <ul className="intro-list">
          ...
          <li>
            <strong>Mitigación de la sobreexplotación:</strong> compensar extracciones intensivas mediante recarga asistida.
          </li>
          <li>
  ...
  <div className="criteria-table-wrap">
    <div style={{ fontWeight: 600, marginBottom: 10, marginLeft: 10 }}>
    ...
    <div style={{ marginTop: 6, fontSize: 15, opacity: 0.75, marginLeft: 10 }}>
...
function Metodologia({ currentMetodoView, setCurrentMetodoView }) {
  ...
  return (
    <section className="metodo-section">
      ...
      <p className="metodo-text-main">
        La metodología SIGMMA-MAR organiza la selección del grupo de técnicas MAR en tres fases articuladas, iniciando con la Fase 1, donde se consolida el panel de insumos y la caracterización integral del sistema mediante modelos conceptuales, unidades hidrogeológicas, análisis de fuente y calidad, volumen-capacidad y el contexto socioambiental. Posteriormente, la Fase 2 constituye el núcleo operativo al presentar las rutas metodológicas que el usuario puede elegir: la ruta jerárquica, que desarrolla el proceso jerárquico analítico (AHP integrado con SIG-MCDA) para ponderar criterios o la ruta automatizada, que aplica modelos de aprendizaje automático como árboles de decisión y bosques aleatorios entrenados con casos históricos para estimar la factibilidad técnica. Finalmente, la Fase 3 comprende la síntesis de resultados y la validación comparativa entre ambas rutas cuando el usuario así lo solicite, permitiendo contrastar la convergencia de las soluciones conforme al flujo representado en la Figura 5, donde la información base de la primera etapa alimenta sistemáticamente tanto el análisis jerárquico como la modelación avanzada.
      </p>
  ...
  >
    <span className="tab-phase-icon">Fase 3</span> Resultados
      ...
      {currentMetodoView === "ahp" && <FaseAHP onGoPhase3={() => setCurrentMetodoView("rf")} />}
...
function FaseInsumos({ onContinueToPhase2 } = {}) {
  ...
  const caseMetaMissing = [];
  if (!isFilledText(currentCase?.nombre)) caseMetaMissing.push("Nombre del caso");
  if (!isFilledText(currentCase?.usuario)) caseMetaMissing.push("Usuario");
  if (!isFilledText(currentCase?.ubicacion)) caseMetaMissing.push("Ubicación");
  const isCaseMetaComplete = caseMetaMissing.length === 0;
  const isInsumosLocked = isReadOnlyCase || !isCaseMetaComplete;
  ...
  useEffect(() => {
    const handler = (event) => {
      ...
      if (modules.length) {
        const labels = modules.map(
          (mid) => INSUMOS_MODULES.find((m) => m.id === mid)?.label || mid
        );
        setScenarioHint({ scenario, modules: labels, moduleIds: modules });
        setActiveTab("datos");
    ...
    window.addEventListener("sigmma:scenario-insumos", handler);
    return () => window.removeEventListener("sigmma:scenario-insumos", handler);
  }, []);
  ...
  function updateModuleEntry(moduleId, entryIndex, fieldName, value) {
    if (isInsumosLocked) return;
    const shouldClearInfra =
      moduleId === "infraestructura" && fieldName === "tipo_infraestructura" && isNoInfraSelection(value);
    ...
    setCases((prev) => {
      ...
      if (shouldClearInfra) {
        const infraFields = MODULE_FIELDS?.infraestructura || [];
        infraFields.forEach((field) => {
          if (field.name !== "tipo_infraestructura") nextEntry[field.name] = "";
        });
      }
  ...
  function isNoInfraSelection(value) {
    return String(value ?? "")
      .toLowerCase()
      .normalize("NFD")
      .replace(/[\u0300-\u036f]/g, "")
      .replace(/[^\w\s-]/g, "")
      .trim()
      .includes("no hay infraestructura");
  }
  ...
  function handleSaveCase() {
    ...
    if (!isCaseMetaComplete) {
      alert("Debes diligenciar Nombre del caso, Usuario y UbicaciÇün antes de guardar.");
      return;
    }
  ...
  }, [minScenario.ok, hydrated, isInsumosLocked, currentCaseId, minScenario.done, minScenario.total]);
  ...
  const MAX_PREVIEW_DATA_URL_MB = 2;
  ...
  async function handleUploadMap(layerId, file, moduleIdForSelection, expectedLayerLabel) {
    ...
    if (isProbablyImageFile(processedFile)) {
      try {
  ...
  function getLayerPreviewSrc(layer, caseObj = currentCase) {
    ...
    return uploaded?.dataUrl || uploaded?.url || layer.preview || "";
  }
    ...
    return (
      <div style={{ marginTop: 12, border: "1px dashed rgba(0,0,0,.18)", borderRadius: 12, padding: 12 }}>
        ...
        >
          {imgError ? (
            <div className="insumos-map-empty">
              Vista previa no disponible. Vuelve a cargar la imagen para visualizarla.
            </div>
          ) : (
            <img
              src={src}
              alt="preview"
              className="insumos-map-image"
              draggable={false}
        ...
        <aside className="fase-insumos-left">
          ...
          <div className="insumos-case-card">
            ...
            <div className="insumos-download-row">
              <button type="button" className="insumos-download-btn" onClick={handleSaveCase} disabled={isReadOnlyCase || !isCaseMetaComplete}>
          ...
          {/* ✅ BLOQUE MÍNIMO */}
          {!isCaseMetaComplete ? (
            <div className="insumos-case-card" style={{ marginTop: 12, fontSize: 14, background: "#fff7ed", border: "1px solid #fed7aa" }}>
              <div style={{ fontWeight: 900, marginBottom: 6 }}>Panel en solo lectura</div>
              <div style={{ fontSize: 14, opacity: 0.9 }}>
                Para habilitar los insumos debes completar:
              </div>
              <ul style={{ margin: "6px 0 0 18px" }}>
                {caseMetaMissing.map((label) => (
                          ...
                          return (
                            <div key={layer.id} className="insumos-map-layer-row">
                              ...
                              <button
                                ...
                                onClick={() => {
                                  if (!checked && !isInsumosLocked) toggleLayerForModule(mod.id, layer.id);
                                  trySelectModule(mod.id);
                                  setActiveLayerId(layer.id);
                                }}
                              >
          ...
          {activeTab === "datos" ? (
            <>
              <header className="insumos-module-header">
                ...
                <button type="button" className="insumos-module-save-btn" onClick={() => handleSaveCase()} disabled={isInsumosLocked}>
                  💾 Guardar
                </button>
              </header>

              {scenarioHint?.modules?.length ? (
                <div className="insumos-scenario-hint">
                  <strong>{`Para habilitar el Escenario ${scenarioHint.scenario} completa estos módulos:`}</strong>{" "}
                  {scenarioHint.modules.join(", ")}.
                </div>
              ) : null}
                ...
                {selectedModuleId === "caracterizacion" ? (
                  ...
                  moduleEntries.map((entry, entryIndex) => (
                    <div key={`entry-${entryIndex}`} className="insumos-entry">
                      {moduleEntries.length > 1 ? (
                        <div className="insumos-entry-header">
                          ...
                          <button
                            type="button"
                            className="insumos-map-layer-action"
                            disabled={isInsumosLocked || moduleEntries.length <= 1}
                      ...
                      {fieldDefs.map((field) => {
                        if (selectedModuleId === "volumen" && field.name === "cap_infiltracion_categoria") {
                          const enabled = entry?.cap_infiltracion_zona_no_saturada === "Si";
                          if (!enabled) return null;
                        }

                        const isInfraNo =
                          selectedModuleId === "infraestructura" && isNoInfraSelection(entry?.tipo_infraestructura);
                        const isInfraLocked = isInfraNo && field.name !== "tipo_infraestructura";

                        const val = entry?.[field.name] ?? "";
                        const isTextArea = field.type === "textarea";
                        const isSelect = field.type === "select";
                        const isNumber = field.type === "number";
                        const fieldDisabled = isInsumosLocked || isInfraLocked;
                        const optionHelp =
                          isSelect && typeof getSelectOptionHelp === "function"
                            ? getSelectOptionHelp(field.name, val)
                            : "";
              ...
              <div className="insumos-maps-related">
                ...
                <div className="insumos-map-add-row">
                  ...
                  <button
                    ...
                    disabled={isInsumosLocked || !String(customLayerLabel || "").trim()}
                  >
                    + Agregar capa
                  </button>
                </div>
                ...
                {moduleLayers.length ? (
                  <>
                    ...
                    <MapViewer
                      ...
                      isReadOnlyCase={isInsumosLocked}
...
function FaseAHP({ onGoPhase3 } = {}) {
  ...
  return (
    <>
      ...
      <Phase2RouteA activeRoute={route} onSelectRoute={setRoute} onGoPhase3={onGoPhase3} />
    </>
  );
}
...
function FaseRF() {
  ...
  return <Resultados ready={Boolean(routeAScores)} />;
}


const DASHBOARD_REPORT_META = {
  general: {
    title: "Ficha técnica SIGMMA-MAR",
    subtitle: "Reporte general que resume insumos, mapas y contexto del caso.",
    note: "Incluye todos los insumos registrados, las capas espaciales adjuntas y los metadatos básicos del estudio.",
  },
  rutaA: {
    title: "Ficha Ruta A",
    subtitle: "Síntesis de puntajes AHP y WLC calculados en la Ruta A.",
    note: (caseData) => {
      const computed = caseData?.phase2?.computedScores;
      const variablesCount = Array.isArray(computed?.variables) ? computed.variables.length : 0;
      const wlcRows = Array.isArray(caseData?.phase2?.wlcResults?.rows) ? caseData.phase2.wlcResults.rows.length : 0;
      return `Variables evaluadas: ${variablesCount}. Filas WLC disponibles: ${wlcRows}.`;
    },
  },
  rutaB: {
    title: "Ficha Ruta B",
    subtitle: "Resumen del modelo automatizado y sus recomendaciones.",
    note: () => "Presenta el comportamiento esperado de la Ruta B (evaluación automática).",
  },
  comparativa: {
    title: "Ficha comparativa",
    subtitle: "Contraste entre la Ruta A (AHP/WLC) y la Ruta B (modelos automáticos).",
    note: () => "Se presentan juntas las visiones de las dos rutas para facilitar la comparación.",
  },
};

const ROUTE_REPORT_TYPES = [
  { id: "rutaA", label: "Ruta A" },
  { id: "rutaB", label: "Ruta B" },
  { id: "comparativa", label: "Comparativa" },
];

function formatCaseResultsDateLabel(caseData) {
  const iso =
    caseData?.phase2?.updatedAtISO || caseData?.updatedAtISO || caseData?.createdAtISO;
...
function Dashboard() {
  ...
  const { activeCaseId, setActiveCaseId } = useCasesStore();
  const routeAPollRef = useRef(null);
  const latestActiveCaseIdRef = useRef(activeCaseId);

  useEffect(() => {
    latestActiveCaseIdRef.current = activeCaseId;
  }, [activeCaseId]);

  useEffect(() => {
    return () => {
      if (routeAPollRef.current) {
        clearTimeout(routeAPollRef.current);
        routeAPollRef.current = null;
      }
    };
  }, []);

  const ensureRouteAExport = useCallback((targetId) => {
    const attempt = () => {
      if (typeof window === "undefined") return;
      if (!window.pendingRouteAExportCaseId) return;
      if (latestActiveCaseIdRef.current !== targetId) {
        routeAPollRef.current = window.setTimeout(attempt, 220);
        return;
      }
      const handler = window.sigmmaExportRouteA;
      if (typeof handler === "function") {
        window.pendingRouteAExportCaseId = null;
        handler();
        routeAPollRef.current = null;
        return;
      }
  ...
  const requestRouteAExport = useCallback(
    (caseData) => {
      const targetId = caseData?.id || caseData?.caseId;
      if (!targetId || typeof window === "undefined") return;
      window.pendingRouteAExportCaseId = targetId;
      if (
        activeCaseId === targetId &&
        typeof window.sigmmaExportRouteA === "function"
      ) {
        window.sigmmaExportRouteA();
        window.pendingRouteAExportCaseId = null;
        return;
      }
      setActiveCaseId(targetId);
      ensureRouteAExport(targetId);
    },
    [activeCaseId, ensureRouteAExport, setActiveCaseId]
  );

  const handleReportClick = useCallback(
    (caseData, reportId) => {
      if (reportId === "rutaA") {
        requestRouteAExport(caseData);
        return;
      }
      exportCaseToPDFLegacy(caseData, reportId);
    },
    [requestRouteAExport]
  );
  ...
  const [downloadAccess, setDownloadAccess] = useState(() => new Set());

  const isDownloadAllowed = useCallback(
    (caseId) => {
      if (!caseId) return false;
      return downloadAccess.has(caseId);
    },
    [downloadAccess]
  );

  const handleDownloadPermission = useCallback(
    (caseData) => {
      const caseId = caseData?.id || caseData?.caseId;
      if (!caseId) return;
      const alreadyAllowed = isDownloadAllowed(caseId);
      const title = caseData?.nombre || caseData?.caseName || caseId;
      const question = alreadyAllowed
        ? `¿Deseas bloquear las descargas para ${title}?`
        : `¿Permites que este caso descargue fichas PDF?`;
      if (!window.confirm(question)) return;
      setDownloadAccess((prev) => {
        const next = new Set(prev);
        if (alreadyAllowed) next.delete(caseId);
  ...
  const attemptReportDownload = useCallback(
    (caseData, reportId) => {
      const caseId = caseData?.id || caseData?.caseId;
      if (!isDownloadAllowed(caseId)) {
        alert("Activa la autorización de descarga antes de continuar");
        return;
      }
      handleReportClick(caseData, reportId);
    },
    [handleReportClick, isDownloadAllowed]
  );
  ...
  function exportCaseToPDFLegacy(caseData, reportType = "general") {
    const escapeHtml = (s) =>
      String(s ?? "")
        .replaceAll("&", "&amp;")
        .replaceAll("<", "&lt;")
    ...
    const reportMeta = DASHBOARD_REPORT_META[reportType] || {
      title: "Ficha MAR",
      subtitle: "Resumen del caso",
      note: "",
    };
    const reportTitle = reportMeta.title || "Ficha MAR";
    const reportSubtitle = reportMeta.subtitle || "";
    const reportNote =
      typeof reportMeta.note === "function" ? reportMeta.note(caseData) : reportMeta.note || "";
    const sanitizedReportTitle = escapeHtml(reportTitle);
    const sanitizedReportSubtitle = escapeHtml(reportSubtitle);
    const sanitizedReportNote = escapeHtml(reportNote);
    ...
    const html = `
      <html>
        <head>
          <title>${sanitizedReportTitle} - ${escapeHtml(caseData.id || "sin ID")}</title>
          <meta charset="utf-8" />
          <style>
        ...
        <body>
          <h1>${sanitizedReportTitle}</h1>
          ${reportSubtitle ? `<p class="subtitle">${sanitizedReportSubtitle}</p>` : ""}
          ...
          ${reportNote ? `<div class="box" style="margin-top:16px;"><div class="k">Nota</div><div class="v">${sanitizedReportNote}</div></div>` : ""}
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          <thead>
            <tr>
              ...
              <th style={{ textAlign: "center", padding: 10, borderBottom: "1px solid rgba(0,0,0,.12)" }}>Descarga</th>
                ...
                return (
                  <tr key={id}>
                    ...
                    >
                      <button
                        type="button"
                        onClick={() => handleDownloadPermission(c)}
                        style={{
                        ...
                        aria-label="Toggle descarga"
                      >
                        {isDownloadAllowed(id) ? "🔓" : "🔒"}
                      </button>
                    </td>
                <td
                      style={{
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {ROUTE_REPORT_TYPES.map((report) => (
                            <button
                              key={report.id}
                              type="button"
                              className="insumos-download-btn"
                              onClick={() => attemptReportDownload(c, report.id)}
                        ...
                        >
                          Caso: {c?.nombre || c?.caseName || c?.id} · Resultados:{" "}
                          {formatCaseResultsDateLabel(c)}
                        </div>
                      </div>
                    </td>
                  </tr>
